...
export default function WishlistPage() {
  ...
  return (
    <div className="container-site py-12 lg:py-20">
      <h1 className="section-title">Ma sélection</h1>
      <p className="mt-4 max-w-xl text-sm leading-relaxed text-brown">
        Vos coups de cœur, gardés au chaud. Votre sélection est enregistrée dans ce navigateur.
      </p>
      ...
      {!hydrated ? (
        ...
        <div className="mt-12 max-w-md">
          <p className="text-sm text-chocolate">Votre sélection est vide pour le moment.</p>
